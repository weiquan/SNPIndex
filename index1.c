...
{
    fprintf(stderr, "\n");
    fprintf(stderr, "snpaln index   <ref.fa>    <variants.txt>  <prefix>"); 
    fprintf(stderr,"\n");
    fprintf(stderr, "\n");
    return 1;
}
...
int index_main(int argc, char *argv[])
{
    ...
    fn_fa = argv[1]; fn_hm = argv[2]; prefix = argv[3];    
    ...
    fprintf(stderr, "build lookuptable from file %s\n", str0);
    LKT_build_lookuptable(str0, lkt);
    fprintf(stderr, "build lookuptable finish!\n");
    LKT_output(str1, lkt);
    fprintf(stderr, "output lookup table to %s\n", str1);
    LKT_destroy(lkt);
    /**********************************************************************/
                            //pac2bwt
    ...
    fprintf(stderr, "convert C pac%s to bwt%s\n", str0, str1);
    t = clock(); 
    ...
    strncpy(str1, prefix, 1024);strcat(str1, ".R");
    fprintf(stderr, "[snpaln_index] build R sa from local pattern %s", str0); 
    Rbwt2_save_sa(str1, str0);
    /*************index mixref****************************/
    //str0 = "prefix.ref"
    strncpy(str0, prefix, 1024);strcat(str0, ".ref");
    fprintf(stderr, "[snpaln_index] build mixRef file %s", str0); 
